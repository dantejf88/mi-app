...
class ServerlessContextManager {
  ...
  handleDBContext(contextContainer) {
    ...
    try {
      ...
      if (serverlessContext.mongoClient && serverlessContext.mongoClient.db && serverlessContext.mongoClient.db.serverConfig && serverlessContext.mongoClient.db.serverConfig.isConnected() && serverlessContext.mongoClient.readyState === 1) {
